...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var e=document.querySelectorAll(".glazing_price_btn"),o=document.querySelectorAll(".popup_calc_close"),s=document.querySelector(".popup_calc"),t=document.querySelector(".balcon_icons"),n=document.querySelectorAll(".balcon_icons-items"),r=document.querySelectorAll(".big_img-item"),u=document.querySelector(".popup_calc_button"),c=document.querySelector(".popup_calc_profile"),d=document.querySelector(".popup_calc_end"),l=document.querySelector("#width"),i=document.querySelector("#height"),a=document.createElement("div"),m=document.querySelector("#view_type"),_=document.querySelectorAll('input[type="checkbox"]'),j={},f=function(e){for(var o=e;o<r.length;o++)r[o].classList.remove("calc_show"),r[o].classList.add("calc_hide"),n[o].classList.remove("do_image_more")};function p(e){e.style.display="block",document.body.style.overflow="hidden"}function v(e){e.style.display="none"}f(1),t.addEventListener("click",function(e){if(e.preventDefault(),e.target&&e.target.classList.contains("balcon_icons-items"))for(var o=0;o<n.length;o++)if(e.target==n[o]){f(0),r[s=o].classList.contains("calc_hide")&&(r[s].classList.remove("calc_hide"),r[s].classList.add("calc_show"),n[s].classList.add("do_image_more")),j.construction=document.querySelector(".balcon_icons .do_image_more").alt;break}var s}),o.forEach(function(e){e.addEventListener("click",function(e){e.currentTarget==o[0]?v(s):e.currentTarget==o[1]?v(c):e.currentTarget==o[2]&&v(d)})}),e.forEach(function(e){e.addEventListener("click",function(){p(s)})}),u.addEventListener("click",function(){""==l.value||""==i.value||"0"==l.value||"0"==height.value?(document.querySelector(".popup_calc_content").appendChild(a),a.innerHTML="Укажите размеры вашего балкона"):(p(c),v(s),j.height=i.value,j.width=l.value),b()});var h=function(){for(var e=0;e<_.length;e++)_[e].checked&&(j.checkBox=_[e].dataset.describe)},y=function(){for(var e=0;e<m.windowData.length;e++)m.windowData[e].selected&&(j.view=m.windowData[e].value)},g=function(){for(var e in j)delete j[e]};function b(){for(var e=0;e<x.length;e++)x[e].value="",setTimeout(function(){a.innerHTML=""},3e3)}c.addEventListener("click",function(e){var o=e.target;"button popup_calc_profile_button"==o.className&&0!=_[0].checked?(p(d),v(c),h(),y()):"button popup_calc_profile_button"==o.className&&0!=_[1].checked?(p(d),v(c),h(),y()):"button popup_calc_profile_button"==o.className&&(document.querySelector(".popup_calc_profile_content").appendChild(a),a.innerHTML="Вы не выбрали тип остекления и его профиль"),b()}),d.addEventListener("click",function(e){var o=e.target;"popup_calc_end_close"!=o.className&&"closed"!=o.className||(v(d),g())});var w=document.querySelectorAll("form")[8],x=document.querySelectorAll("input");w.addEventListener("submit",function(e){e.preventDefault();var o=new XMLHttpRequest;o.open("POST","./server.php"),o.setRequestHeader("Content-Type","application/json; charset=utf-8"),new FormData(w).forEach(function(e,o){j[o]=e});var s=JSON.stringify(j);o.send(s),o.addEventListener("readystatechange",function(){o.readyState<4?(document.querySelector(".form_and").appendChild(a),a.innerHTML="Идет отправка"):(4===o.readyState&&200==o.status?(document.querySelector(".form_and").appendChild(a),a.innerHTML="Отправлено!"):(document.querySelector(".form_and").appendChild(a),a.innerHTML="Ошибка!"),b(),g())})});for(var S=function(n){x[n].addEventListener("keypress",function(e){var o=e.keyCode,s=x[n].getAttribute("name"),t=x[n].id;"user_phone"!=s&&"width"!=t&&"height"!=t||(o<48||57<o)&&e.preventDefault()})},k=0;k<x.length;k++)S(k);_[1].addEventListener("change",function(){_[0].checked=!_[1].checked}),_[0].addEventListener("change",function(){_[1].checked=!_[0].checked})}},"./src/js/parts/form.js":
/*!******************************!*\
